/*
  Full Name: Christopher Ermel
  Student ID: 200250446
...
const people = [
  {firstName:"Christopher", lastName:"Ermel", color:"Yellow"},
  {firstName:"Ben", lastName:"Kearns", color:"Blue"},
  {firstName:"Tony", lastName:"Woo", color:"Green"},
  {firstName:"JL", lastName:"Fortin", color:"Red"}
];
...
const personFavouriteColor = ({firstName, lastName, color}) => {
  console.log(`${firstName} ${lastName}'s favourite color is ${color}.`);
};
